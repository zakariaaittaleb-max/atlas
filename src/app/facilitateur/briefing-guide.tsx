  ...
  return (
    <div className="space-y-4">
      <div className={`${color} -mx-6 px-6 py-3 rounded-lg`}>
        ...
        <h3 className="text-lg font-semibold mt-1 text-black">{title}</h3>
      </div>
  ...
  return (
    <div className="relative">
      <div className="flex gap-4">
        <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-(--accent) text-(--on-accent) font-bold text-sm">
          {number}
        </div>
