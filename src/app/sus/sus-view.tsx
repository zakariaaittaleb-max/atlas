...
import { submitSusResponseAction } from './actions';
import type { SusAggregate } from '@/lib/server/sus';
...
export function SusView({
  alreadySubmitted, myScore, initialAggregate,
}: {
  ...
  async function submit() {
    ...
    setError(null);
    setBusy(true);
    const res = await submitSusResponseAction({ label, answers: values, comment });
    setBusy(false);
